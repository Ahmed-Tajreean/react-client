                ...
                fetch(`http://localhost:5000/createAssignments/user/${_id}`, {
                    ...
                    .then((data) => {
                        ...
                        if (data.deletedCount > 0) {
                            ...
                            const remaining = allAssignments.filter(tour => tour._id !== _id);
    ...
    return (
        <div className="flex items-center justify-center m-6 ">
            <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-xl  hover:shadow-2xl transition duration-300 bg-gradient-to-br from-[#2C3E50] to-[#4CA1AF]">
                <div className="p-10 ">
                    <img className="object-cover object-center w-full h-56 rounded-xl" src={photoURL} alt="avatar" />
                </div>

                <div className="flex justify-center mt-4 gap-4">
                    <div className="flex items-center lg:px-3 lg:py-3 bg-gray-900 border-teal-600 border-2 rounded-lg">
                        <h1 className="mx-3 text-lg font-semibold text-white">Marks : <span>{marks}</span></h1>
                    </div>
                    <div className="flex items-center px-3 py-3 bg-gray-900 border-teal-600 border-2 rounded-lg">
                        <h1 className="mx-3 text-lg font-semibold text-white">Difficulty : <span>{difficulty}</span></h1>
                    </div>
                ...
                <div className="px-6 py-4">
                    ...
                    <p className="py-2 text-white ">Full Stack maker & UI / UX Designer , love hip hop music Author of Building UI.</p>
                    ...
                    <div className="flex gap-2 justify-center">
                        ...
                        {user && user.email === userEmail ? (
                            <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                <div className="grid  place-content-center bg-slate-900">
                                    <DrawOutlineButton onClick={() => handleDelete(_id)}>Delete</DrawOutlineButton>
                                </div>
                            </div>
                            ...
                            (
                                <div className="btn-disabled items-center mt-4 text-gray-400 dark:text-gray-200">
                                    <div className="grid  place-content-center bg-slate-900">
                                        <DrawOutlineButton onClick={() => handleDelete(_id)}>Delete</DrawOutlineButton>
                                    </div>
                                </div>
