...
const UpdateAssignments = () => {
    ...
    const {
        _id, photoURL, title, marks, difficulty, dueDate, userEmail, shortDescription, email
    } = allAssignments;
    ...
    const onSubmit = (data, event) => {
        ...
        const {
            photoURL, title, marks, difficulty, dueDate, userEmail, shortDescription
        } = data;
        const {
            email,
        } = user;
        const updatedAssignment = {
            photoURL, title, marks, difficulty, dueDate, userEmail, shortDescription, email
        };
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        type="url" defaultValue={photoURL}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select
                                        {...register("difficulty", { required: true })} defaultValue={difficulty}
                                        className="w-full mt-2 border border-gray-300 rounded-md py-2 px-4 focus:outline-none focus:border-blue-500"
                                    >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        type="email" defaultValue={userEmail}
                                ...
                                <div>
                                    ...
                                    <input
                                        type="date" defaultValue={dueDate}
                            ...
                            <div>
                                ...
                                <textarea
                                    {...register("shortDescription", { required: true })} defaultValue={shortDescription}
